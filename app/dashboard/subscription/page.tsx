...
export default function SubscriptionPage() {
  ...
  const subtotal = billingCycle === "yearly" ? plan.price * 10 : plan.price;
  const trialText = selectedPlan === "Pro" ? "3-day free trial included" : "No free trial on this plan";
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
              ...
              payment page. The free trial is only available on Pro and lasts 3 days.
            </p>
          </div>
          <div className="rounded-2xl bg-emerald-50 px-5 py-4 text-sm font-semibold text-emerald-800 ring-1 ring-emerald-100">
          ...
          {plans.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p className={`mt-2 text-sm font-semibold ${item.name === "Pro" ? "text-emerald-700" : "text-slate-500"}`}>
        ...
        <aside className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm shadow-slate-200/70">
          ...
          <div className="mt-6 space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-slate-500">{plan.name} plan</span>
            ...
            <div className="border-t border-slate-200 pt-3">
              <div className="flex justify-between">
                <span className="font-semibold text-slate-950">Due on payment page</span>
